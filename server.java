...
public class server extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println(kT.outputMap);
            ...
            while (true) {
                try {
                    ...
                    if (incomingMessage.getMessageType() == 0) { // Application Message
                        ...
                        System.out.println("Message Type: " + incomingMessage.getMessageType() + " From: "
                        ...
                        if (kT.iterator < itr) {
                            ...
                            if (kT.id == incomingMessage.getLabelValue()) { // iterator's id == mine => start
                                ...
                                // for (long stop = System.currentTimeMillis() + kT.minDelay; stop >
                        ...
                        // System.out.println("Message Type: " + incomingMessage.getMessageType() + "
                        // From: "+ incomingMessage.getId());
                        int nodeId = incomingMessage.getId();
